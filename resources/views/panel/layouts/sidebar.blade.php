<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('home')}}" class="brand-link">
      <img src="{{ asset('public/dist/img/icon.png') }}" alt="Exclusive Job Preparation Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{route('app-user-view')}}" class="nav-link">
                      <i class="fas fa-user-plus nav-icon"></i>
                      <p>Registered App Users</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{route('view-push-notification')}}" class="nav-link">
                      <i class="fas fa-comment-alt nav-icon"></i>
                      <p>Push Notification</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{route('view-sms-notification')}}" class="nav-link">
              ...
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="{{route('section-view')}}" class="nav-link">
                      <i class="fas fa-align-justify nav-icon"></i>
                      <p>Sections</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{route('model-view')}}" class="nav-link">
                      <i class="fas fa-scroll nav-icon"></i>
                      <p>Models</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{route('subject-view')}}" class="nav-link">
