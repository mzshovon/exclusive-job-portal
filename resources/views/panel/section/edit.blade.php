...
<section class="content-header">
    <div class="container-fluid">
      <form role="form" action="{{route('section-update',['id'=>$section->id])}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
          <div class="col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-md-2">
                                @if ($section->icon)
                                    <img class="icon_image" src="{{asset($section->icon)}}" style="margin:20px;height:30px;width:30px">
                                @endif
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <div class="input-group my-colorpicker2">
                                <input type="text" class="form-control" name="color" value="{{$section->color}}">
                                <div class="input-group-append">
