...
<section class="content-header">
    <div class="container-fluid">
      <form role="form" action="{{route('update-push-notification',['id'=>$push_notification])}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
          <div class="col-md-12">
                          ...
                          <div class="col-md-4">
                            <label class="col-form-label" for="inputSuccess">Code <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    ...
                                    <input type="text" id="title" name="code" class="form-control" placeholder="Ex. BD-EXCLSV-SMS-12312" value="{{$push_notification->code}}">
                                </div>
                          </div>
                          <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control select2" id="status" name="status" style="width: 100%;">
                                    ...
                                    <option value="1" {{$push_notification->status == '1' ? 'selected':''}}>Active</option>
                                    <option value="0" {{$push_notification->status == '0' ? 'selected':''}}>Deactive</option>
                                  </select>
                            </div>
                          </div>
                          <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control select2" id="language" name="language" style="width: 100%;">
                                    ...
                                    <option value="en" {{$push_notification->language == 'en' ? 'selected':''}}>English</option>
                                    <option value="bn" {{$push_notification->language == 'bn' ? 'selected':''}}>Bangla</option>
                                  </select>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="duration" value="{{$push_notification->duration}}">
                              </div>
