...
<section class="content-header">
    <div class="container-fluid">
      <form role="form" action="{{route('role-create')}}" method="post">
        @csrf
        <div class="row">
          <div class="col-md-6">
            <div class="card card-info">
              ...
              <div class="card-body form-data-role">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control name" id="inputSuccess" name="name" placeholder="Enter Valid Role Name in Lower Case..." required>
                </div>
                <div class="form-group">
                  <label class="col-form-label" for="inputSuccess">Display Name <span class="text-danger">*</span></label>
                  <input type="text" class="form-control display_name" id="inputSuccess" name="display_name" placeholder="Enter Valid Role Name in Small Letter..." readonly>
                </div>
                <div class="form-group">
                  <label>Description <small>(Optional)</small></label>
                  <textarea class="form-control" rows="3" name="description" placeholder="Describe about the role ..."></textarea>
                </div>
              </div>
            </div>
          </div>
                        ...
                        @forelse ($permissions as $permission)
                          <div class="col-md-6">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                              <input type="checkbox" class="custom-control-input" name="permissions[]" value="{{$permission->id}}" id="customSwitch{{$permission->id}}">
