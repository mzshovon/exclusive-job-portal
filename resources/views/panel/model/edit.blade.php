...
<section class="content-header">
    <div class="container-fluid">
      <form role="form" action="{{route('model-update',['id'=>$model->id])}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
          <div class="col-md-12">
              ...
              <div class="card-body form-data-role">
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-md-2">
                                @if ($model->icon)
                                    <img class="icon_image" src="{{asset($model->icon)}}" style="margin:20px;height:30px;width:30px">
                                @endif
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <label>Assign Subjects <span class="text-danger">*</span></span></label>
                                <div class="select2-purple">
                                <select class="select2" data-dropdown-css-class="select2-purple" multiple="multiple" data-placeholder="Select Subjects" name="subject[]" style="width: 100%;">
                                  @forelse ($subjects as $subject)
                                    <option value="{{$subject->id}}" {{in_array($subject->id, $subject_list) ? 'selected':''}}>{{$subject->title}}</option>
                                  @empty
                                      No Data Found
                                  @endforelse
                                </select>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="textarea form-control" rows="3" name="description" placeholder="Describe about the model ..." style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                        {!! $model->description !!}
                      </textarea>
                    </div>
                    </div>
